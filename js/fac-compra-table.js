        ...
        init: function() {
            ...
            $('#editable-sample a.edit').live('click', function(e) {
                ...
                if (nEditing !== null && nEditing != nRow) {
                    ...
                    var uri = '/fenix/sistema/compra_controller/guardarArtFacCompra';
                    if (window.location.host !== 'localhost') {
                        uri = '/sistema/compra_controller/guardarArtFacCompra';
                    }

                    //Actualiza el costo
                    $.ajax({
                        url: uri,
                        data: {proveedor: _proveedor, factura: _factura, fecha: _fecha_oc, codfenix: _codfenix, interno: _interno, costo: _costo, cantidadped: _cantidadped, dto1: _dto1, dto2: _dto2, dto3: _dto3, rec1: _rec1, moneda: _moneda, testigo: _testigo, descripcion_lista: _descripcion_lista},
                        type: 'POST',
            ...
            $('#interno').live("keypress", function(e) {
                ...
                if (e.keyCode === 13) {
                    ...
                    var uri = '/fenix/sistema/compra_controller/buscarCosto';
                    if (window.location.host !== 'localhost') {
                        uri = '/sistema/compra_controller/buscarCosto';
                    }
            ...
            $('#cod-fenix').live("keypress", function(e) {
                ...
                if (e.keyCode === 13) {
                    ...
                    var uri = '/fenix/sistema/compra_controller/buscarArticuloCosto';
                    if (window.location.host !== 'localhost') {
                        uri = '/sistema/compra_controller/buscarArticuloCosto';
                    }
                    ...
                    $.ajax({
                        ...
                        success: function(data) {
                            ...
                            if (error === 1) {
                                ...
                                if (datosJson.ocompra !== undefined){
                                    datosOCompra = "<table class='' border='1' align='right'>" +
                                            "<caption>ORDEN DE COMPRA PENDIENTE</caption>" +
                                            "<thead>" +
                                            "<tr>" +
                                            "<th>OCompra</th>" +
                                            "<th>Fecha</th>" +
                                            ...
                                            "<tbody>" + 
                                            "<tr>" +
                                            "<th>" + datosJson.ocompra + "</th>" +
                                            "<th>" + datosJson.fecha_ocompra + "</th>" +
                                            "<th>" + datosJson.cantidadped + "</th>" +
                                            "<th>" + datosJson.cantidadrec + "</th>" +
                                            "<th>" + datosJson.costo + "</th>" +
                                            "</tr>" +
                                            "</tbody>" +
                                            "</table>" ;
                                ...
                                $('#info-consulta').html(datosJson.descripcion);
                                $('#info-ocompra').html(datosOCompra);
            ...
            $('#guardar-factura').click(function() {
                ...
                var uri = '/fenix/sistema/compra_controller/guardarFaccompra';
                if (window.location.host !== 'localhost') {
                      uri = '/sistema/compra_controller/guardarFacCompra';
                }
                //
                $.ajax({
                    url: uri,
                    data: {proveedor:_proveedor, factura: _factura, sucursal: _sucursal},
                    type: 'POST',
                    success: function(data) {
                        var datosJson = JSON.parse(data);
