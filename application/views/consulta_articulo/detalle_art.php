            ...
            <form method="post" action="consulta_articulos" id="form_consulta">
                <div class="row-fluid">
                    ...
                    <div class="span2">
                        ...
                        $res = mysql_query($link, $sql_reemplazo);
                        $reemplazo = '';
                        $marca = '';
                ...
                <div class="row-fluid">
                    <div class="span2">
                        ...
                        $res = mysql_query($link, $sql_proveedor);
                    ...
                    <div class="span2">
                        ...
                        $res = mysql_query($link, $sql_marca);
                        @$row = mysql_fetch_array($res);
                        $marca = $row['nombre'];*/
                        if ($marca != '') {
                            echo '<h3>' . $marca . '</h3>';
                    ...
                    <div class="span2">
                        ...
                        $res = mysql_query($link, $sql_rubro);
                        $row = mysql_fetch_array($res);
                    ...
                    <div class="span2">
                        ...
                        $res_ubi = mysql_query($link, $sql_ubi);
