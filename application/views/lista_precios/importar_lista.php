    ...
    if($codigo_proveedor == '000') {
        ...
        */
        ...
        while ($row_vw = mysql_fetch_array($res_vw)) {
            ...
            $res_descrip = mysql_query($sql_descrip);
            while ($row_descrip = mysql_fetch_array($res_descrip)) {
        ...
        if ($res_droptable) {
            ...
            if ($res_createtable) {
                ...
                if ($script != '' && $post_script != '') {
                    $res_postscript = mysql_query($post_script);
                    if (!$res_postscript){
                ...
                if ($res_loaddata) {
                   ...
                   $registros_importados = $row['registros'];
                     ...
                     die('Error al Importar lista:'. $load_data . '<br/>'. mysql_error());    
                 }
            }
        }
