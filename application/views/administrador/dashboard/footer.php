...
<script src="<?= base_url() ?>assets/js/home-page-calender.js"></script>
<script src="<?= base_url() ?>assets/js/home-chartjs.js"></script>

<script src="<?= base_url() ?>assets/chosen-bootstrap/chosen/chosen.jquery.min.js"></script>
...
<script src="<?= base_url() ?>js/dynamic-table.js"></script>


<script src="<?= base_url() ?>js/transferencia-table.js"></script>

<script>
    jQuery(document).ready(function() { 
        $(".chzn-select").chosen(); $(".chzn-select-deselect").chosen({allow_single_deselect:true});
    });
    function copiarReemplazo(reemplazo) {
        	var $original = $("input[name='original']");
        	$original.val(reemplazo);
        	$original.focus();
    };
</script>
<!-- END JAVASCRIPTS -->
