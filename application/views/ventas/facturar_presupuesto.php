            ...
            <div class="row-fluid">
                <div class="span12" style="margin-left: 0px;">
                    ...
                    <h3 class="page-title">
                        ...
                        Facturar Presupuesto Nro: <?php echo $presupuesto_nro;?>
                    </h3>
                ...
                <div class="widget green">
                    ...
                    <div class="widget-body">
                        ...
                        <div class="row-fluid text-center">
                            ...
                            <a class="btn btn-inverse btn-large" id="btn-facturar">Facturar <i class="icon-archive icon-big"></i></a>
                        </div>
                    </div>
                </div>
...
$('#btn-facturar').click(function() {
   ...
   var msgHTML = '<div>¿Desea facturar los siguientes items?</div>';
   if (artsSeleccionados.length === 0) {
       alert('Debe seleccionar artículos para realizar la factura');
   } else {
...
$('#btn-facturar-ok').click(function(){
        ...
        $.ajax({
            ...
            success: function(data) {
                ...
                $('#btn-facturar-ok').text('Facturar');
                $('#btn-facturar-ok').attr('disabled', false);
                
                //Modal Factura OK
                $('#factura-ok-body').html("Factura Nro: " + factura_nro + " generada con éxito");
                $('#factura-ok-modal').modal();
            },
            error:function() {
                  $('#msg-modal-error').html("Error al presupuesto");
                  $('#modal-error').modal();
