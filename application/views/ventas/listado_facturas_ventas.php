            ...
            <div class="row-fluid">
                <div class="span12">
                    ...
                    <h3 class="page-title">
                        ...
                        Listado Facturas de Compra
                    </h3>
                    <!-- END PAGE TITLE & BREADCRUMB-->
                </div>
            </div>
            <?php
            $query_prov = "SELECT proveedor_id,p.codigo_proveedor, p.`nombre_proveedor` ,
                l.`nombre_archivo`, l.`id`
                FROM listas l
            ...
            <div class="span12">
                ...
                <div class="widget purple">
                    <div class="widget-title">
                        <h4><i class="icon-reorder"></i> Facturas de Compra</h4>
                        <span class="tools">
                        ...
                        <div>
                            ...
                            <table class="table table-striped table-hover table-bordered" id="editable-sample">
                                ...
                                <tbody>
                                    ...
                                    COUNT(*) AS items,
                                    SUM(costo * (1-dto1/100) * (1-dto2/100) * (1-dto3/100) * cantidad) AS importe
                                    FROM facturas_compras fc
                                    INNER JOIN proveedores p ON p.`id`  = fc.`proveedor_id`
                                    WHERE factura <> ''
                                    GROUP BY factura";
                                    $res_ocompra = mysql_query($sql_ocompra);
                                    while ($row_ocompra = mysql_fetch_array($res_ocompra)) {
                                        ...
                                        <tr>
                                            ...
                                            <td><a class="btn btn-primary" href="recepcion?ocompra=<?php echo $row_ocompra['ocompra']; ?>&nombre=<?php echo $row_ocompra['nombre_proveedor']; ?>&fecha=<?php echo $row_ocompra['fecha']; ?>&sucursal=<?php echo $row_ocompra['factura']; ?>&items=<?php echo $row_ocompra['items']; ?>&total=<?php echo $importe_total; ?>" >Recepcion</a></td>
                                        </tr>
                                        <?php
                                    }
                                    ?>
